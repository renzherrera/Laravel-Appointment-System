                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Date:</label>
                                            <div class="input-group date" id="appointmentDate" data-target-input="nearest" data-appointmentdate="@this" wire:ignore>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group" wire:ignore>
                                            ...
                                            <textarea id="note"  data-note="@this" class="form-control"  data-target="#note" wire:model.defer="state.note"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
